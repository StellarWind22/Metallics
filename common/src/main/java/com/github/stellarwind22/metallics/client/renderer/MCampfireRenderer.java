...
public class MCampfireRenderer implements BlockEntityRenderer<MCampfireBlockEntity> {
    ...
    public void render(MCampfireBlockEntity campfireBlockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j) {
